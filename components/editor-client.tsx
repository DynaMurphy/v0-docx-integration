...
export default function EditorClient() {
  ...
  useEffect(() => {
    if (accounts.length > 0) {
      ...
      // This is the WOPI access token, not the MSAL one.
      // It's generated by our host to authorize WOPI calls.
      const wopiToken = generateWopiToken(fileId, { name: user.name, email: user.username })
      setAccessToken(wopiToken)
